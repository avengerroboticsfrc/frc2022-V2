...
public class SixBAutoTrajectory5 extends CommandBase {
    public Command SixBallAutonBlue5(DriveTrain drive) {
      ...
      var autoVoltageConstraint =
        ...
        Trajectory path5 = PathPlanner.loadPath("Trajectory3-5bAuto", 3, 3);
    
        RamseteCommand ramseteCommand5 =
        new RamseteCommand(
            path5,
            drive::getPose,
        ...
        drive.resetOdometry(path5.getInitialPose());
    
        return ramseteCommand5.andThen(() -> drive.tankDriveVolts(0, 0));
}
}
