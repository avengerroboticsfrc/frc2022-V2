...
public class SixBAutoTrajectory3 extends CommandBase{
    public Command SixBallAutonBlue3(DriveTrain drive) {
        ...
        Trajectory path3 = PathPlanner.loadPath("Trajectory5-5bAuto", 3, 3);
        ...
        drive.resetOdometry(path3.getInitialPose());
    
        return ramseteCommand3.andThen(() -> drive.tankDriveVolts(0, 0));
}
}
