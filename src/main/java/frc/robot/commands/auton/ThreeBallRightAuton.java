...
public class ThreeBallRightAuton extends SequentialCommandGroup {
  public ThreeBallRightAuton(DriveTrain drive, Limelight limelight, Shooter shooter, Intake intake, Index index, double intakePower, double intakeToIndexPower, double indexPower, double indexToShooterPower, double shooterPower) {
    ...
    commands.put(1.484711222788454, new PickUpBallCommandGroup(intake, index, shooterPower, shooterPower, shooterPower).withTimeout(3));
